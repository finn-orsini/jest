    ...
    value: function _makeComponent(metadata, restore) {
      ...
      if (metadata.type === 'object') {
        ...
        f.mockReturnValueOnce = function (value) {
          return (// next function call will return this value or default return value
            f.mockImplementationOnce(function () {
              return value;
            })
          );
        };
        ...
        f.mockReturnValue = function (value) {
          return (// next function call will return specified return value or this one
